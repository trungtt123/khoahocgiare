                    ...
                    >
                      ...
                      <div className="p-4 sm:p-6 select-none">
                        ...
                        <div className="flex items-center text-xs sm:text-sm text-gray-500 mb-1 sm:mb-2">
                          ...
                          <span className="truncate">Người tạo: {video.user?.username || 'Đang cập nhật'}</span>
                        </div>
                        ...
                        <button
                          ...
                          className="w-full px-3 py-2 sm:px-4 sm:py-3 text-xs sm:text-sm font-medium text-white bg-gradient-to-r from-blue-600 to-indigo-600 rounded-lg hover:from-blue-700 hover:to-indigo-700 transition-all duration-200 flex items-center justify-center"
                        >
